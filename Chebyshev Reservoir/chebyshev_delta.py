...
df_m.to_csv('del_vs_m_zx.csv', index=False)
...
df_a.to_csv('del_vs_a_zx.csv', index = False)

# x from z
m_values = range(20, 500)
delta_m = []
for i in m_values:
    pred, v_test, t_test, log_del, delta = rc(i, 9, alpha, 2, 0)
    delta_m.append(delta)

df_m = pd.DataFrame({'m': list(m_values), 'delta': delta_m})
df_m.to_csv('del_vs_m_xz.csv', index=False)
...
df_a = pd.DataFrame({'alpha': a_values, 'delta': delta_a})
df_a.to_csv('del_vs_a_xz.csv', index=False)
...
df_m = pd.DataFrame({'m': list(m_values), 'delta': delta_m})
df_m.to_csv('del_vs_m_yx.csv', index = False)
...
df_a = pd.DataFrame({'alpha': a_values, 'delta': delta_a})
df_a.to_csv('del_vs_a_yx.csv', index=False)

# x from y
m_values = range(20, 500)
delta_m = []
for i in m_values:
    pred, v_test, t_test, log_del, delta = rc(i, 9, alpha, 1, 0)
    delta_m.append(delta)

df_m = pd.DataFrame({'m': list(m_values), 'delta': delta_m})
df_m.to_csv('del_vs_m_xy.csv', index=False)
...
df_a = pd.DataFrame({'alpha': a_values, 'delta': delta_a})
df_a.to_csv('del_vs_a_xy.csv', index=False)

# z from y
m_values = range(20, 500)
delta_m = []
for i in m_values:
    pred, v_test, t_test, log_del, delta = rc(i, 9, alpha, 1, 2)
    delta_m.append(delta)

df_m = pd.DataFrame({'m': list(m_values), 'delta': delta_m})
df_m.to_csv('del_vs_m_zy.csv', index=False)
...
for i in a_values:
    pred, v_test, t_test, log_del, delta = rc(m, M, i, 1, 2)
    delta_a.append(delta)

df_a = pd.DataFrame({'alpha': a_values, 'delta': delta_a})
df_a.to_csv('del_vs_a_zy.csv', index=False)

# y from z
m_values = range(20, 500)
delta_m = []
for i in m_values:
    pred, v_test, t_test, log_del, delta = rc(i, 9, alpha, 2, 1)
    delta_m.append(delta)

df_m = pd.DataFrame({'m': list(m_values), 'delta': delta_m})
df_m.to_csv('del_vs_m_yz.csv', index = False)
...
for i in a_values:
    pred, v_test, t_test, log_del, delta = rc(m, M, i, 2, 1)
    delta_a.append(delta)

df_a = pd.DataFrame({'alpha': a_values, 'delta': delta_a})
df_a.to_csv('del_vs_a_yz.csv', index = False)